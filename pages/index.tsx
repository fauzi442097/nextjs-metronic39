              ...
              <div className="card overflow-hidden h-md-50 mb-5 mb-xl-10">
                ...
                <div className="card-body d-flex justify-content-between flex-column px-0 pb-0">
                  ...
                  <div className="mb-4 px-9">
                    ...
                    {/*end::Info*/}
                    {/*begin::Description*/}
                    <span className="fs-6 fw-semibold text-gray-400">Total Online Sales</span>
                    {/*end::Description*/}
                  </div>
                  {/*end::Statistics*/}
                  {/*begin::Chart*/}
                  <div id="kt_card_widget_8_chart" className="min-h-auto" style={{height: '125px'}} />
                  {/*end::Chart*/}
                </div>
                {/*end::Card body*/}
              </div>
              ...
              <div className="card overflow-hidden h-md-50 mb-5 mb-xl-10">
                ...
                <div className="card-body d-flex justify-content-between flex-column px-0 pb-0">
                  ...
                  <div className="mb-4 px-9">
                    ...
                    {/*end::Statistics*/}
                    {/*begin::Description*/}
                    <span className="fs-6 fw-semibold text-gray-400">Total Online Visitors</span>
                    {/*end::Description*/}
                  </div>
                  {/*end::Statistics*/}
                  {/*begin::Chart*/}
                  <div id="kt_card_widget_9_chart" className="min-h-auto" style={{height: '125px'}} />
                  {/*end::Chart*/}
                </div>
                {/*end::Card body*/}
              </div>
          ...
          <div className="card h-md-100" dir="ltr">
            ...
            <div className="card-body d-flex flex-column flex-center">
              ...
              <div className="text-center mb-1">
                {/*begin::Link*/}
                <a className="btn btn-sm btn-primary me-2" href="../../demo39/dist/apps/ecommerce/customers/listing.html">Try now</a>
                {/*end::Link*/}
                {/*begin::Link*/}
                <a className="btn btn-sm btn-light" href="../../demo39/dist/apps/invoices/view/invoice-1.html">Learn more</a>
                {/*end::Link*/}
              </div>
              {/*end::Links*/}
            </div>
        ...
        <div className="col-xl-4 mb-5 mb-xl-10">
          ...
          <div className="card card-flush h-md-100">
            ...
            <div className="card-header pt-7">
              ...
              {/*begin::Toolbar*/}
              <div className="card-toolbar">
                <a href="../../demo39/dist/apps/ecommerce/catalog/categories.html" className="btn btn-sm btn-light">View All</a>
              </div>
              {/*end::Toolbar*/}
            </div>
            {/*end::Header*/}
        ...
        <div className="col-xl-4 mb-xl-10">
          ...
          <div className="card card-flush h-xl-100">
            ...
            <div className="card-header pt-7 mb-5">
              ...
              {/*begin::Toolbar*/}
              <div className="card-toolbar">
                <a href="../../demo39/dist/apps/ecommerce/sales/listing.html" className="btn btn-sm btn-light">View All</a>
              </div>
              {/*end::Toolbar*/}
            </div>
            {/*end::Header*/}
      ...
      <div className="row g-5 g-xl-10 g-xl-10">
            ...
            <div className="card-body d-flex align-items-end">
              ...
              <div className="w-100">
                ...
                <div className="text-center pt-8 d-1">
                  <a href="../../demo39/dist/apps/ecommerce/sales/details.html" className="text-primary opacity-75-hover fs-6 fw-bold">View Store Analytics
        ...
        <div className="col-xl-8">
          ...
          <div className="card card-flush h-xl-100">
            ...
            <div className="card-body pt-5">
              {/*begin::Chart container*/}
              <div id="kt_charts_widget_15_chart" className="min-h-auto ps-4 pe-6 mb-3 h-350px" />
              {/*end::Chart container*/}
            </div>
            {/*end::Body*/}
          </div>
