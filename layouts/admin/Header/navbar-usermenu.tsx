  ...
  return (    
   <div className="app-navbar-item ms-2 ms-lg-6 me-lg-5" id="kt_header_user_menu_toggle">
      ...
      <div className="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
         <img src="/img/avatars/300-2.jpg" alt="user" />
      </div>
      ...
      <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
         ...
         <div className="menu-item px-3">
            ...
            <div className="symbol symbol-50px me-5">
               <img alt="Logo" src="/img/avatars/300-2.jpg" />
            </div>
            {/*end::Avatar*/}
            {/*begin::Username*/}
         ...
         <div className="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
            ...
            <span className="menu-title position-relative">Language
               <span className="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">English
                  <img className="w-15px h-15px rounded-1 ms-2" src="/img/flags/united-states.svg" alt="" /></span></span>
            </a>
            {/*begin::Menu sub*/}
            <div className="menu-sub menu-sub-dropdown w-175px py-4">
               ...
               <div className="menu-item px-3">
                  <a href="../../demo39/dist/account/settings.html" className="menu-link d-flex px-5 active">
                     ...
                     <img className="rounded-1" src="/img/flags/united-states.svg" alt="" />
                     </span>English</a>
               </div>
               {/*end::Menu item*/}
               ...
               <div className="menu-item px-3">
                  <a href="../../demo39/dist/account/settings.html" className="menu-link d-flex px-5">
                     <span className="symbol symbol-20px me-4">
                     <img className="rounded-1" src="/img/flags/spain.svg" alt="" />
                     </span>Spanish</a>
               </div>
               {/*end::Menu item*/}
               ...
               <div className="menu-item px-3">
                  <a href="../../demo39/dist/account/settings.html" className="menu-link d-flex px-5">
                     <span className="symbol symbol-20px me-4">
                     <img className="rounded-1" src="/img/flags/germany.svg" alt="" />
                     </span>German</a>
               </div>
               {/*end::Menu item*/}
               ...
               <div className="menu-item px-3">
                  <a href="../../demo39/dist/account/settings.html" className="menu-link d-flex px-5">
                     <span className="symbol symbol-20px me-4">
                     <img className="rounded-1" src="/img/flags/japan.svg" alt="" />
                     </span>Japanese</a>
               </div>
               {/*end::Menu item*/}
               ...
               <div className="menu-item px-3">
                  <a href="../../demo39/dist/account/settings.html" className="menu-link d-flex px-5">
                     <span className="symbol symbol-20px me-4">
                     <img className="rounded-1" src="/img/flags/france.svg" alt="" />
                     </span>French</a>
               </div>
               {/*end::Menu item*/}
            </div>
