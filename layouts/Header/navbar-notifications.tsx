...
const NavbarNotifications = () => {
  return (
   <div className="app-navbar-item ms-2 ms-lg-6">
      {/*begin::Menu- wrapper*/}
         <div className="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            <i className="fonticon-alarm fs-2" />
         ...
         <div className="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
            {/*begin::Heading*/}
            <div className="d-flex flex-column bgi-no-repeat rounded-top" style={{backgroundImage: 'url("/img/misc/menu-header-bg.jpg")'}}>
               {/*begin::Title*/}
            ...
            <div className="tab-content">
               ...
               <div className="d-flex flex-column px-9">
                  ...
                  <div className="text-center px-4">
                     <img className="mw-100 mh-200px" alt="image" src="/img/illustrations/sketchy-1/1.png" />
                  </div>
                  {/*end::Illustration*/}
               </div>
               {/*end::Wrapper*/}
